...
# start static pages __________________________-
    ...
    path('createorder', OrderCreate.as_view(template_name='createorder.html', lan='ru'), name='createorder'),
    path('createorder_en', OrderCreate.as_view(template_name='createorder_en.html', lan='en'), name='createorder_en'),
    path('createorder_ge', OrderCreate.as_view(template_name='createorder_ge.html', lan='ge'), name='createorder_ge'),
