...
class CityDirectory(models.Model):
...
class OrderList(models.Model):
    ...
    address_city_id = models.ForeignKey("CityDirectory", on_delete=models.PROTECT, verbose_name='Город')
...
class RepairerList(models.Model):
    ...
    city_id = models.ForeignKey("CityDirectory", on_delete=models.PROTECT, verbose_name='Город', related_name='city')
